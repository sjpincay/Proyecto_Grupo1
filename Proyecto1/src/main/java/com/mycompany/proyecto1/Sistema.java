...
/**
 * Clase principal, en esta clase se encontrara el metodo main y es el nucleo
 * del programa Ademas es la unica clase que interaccionara directamente con los
 * ficheros Dispone de metodos estaticos para leer, escribir y borrar datos de
 * los ficheros depenediendo de lo que se hara ninguna otra clase tiene los
 * derechos de proder interactuar con los ficheros se lo realiza de esta forma
 * para tener una estructura mas organizada tratando de simular una base de
 * datos y servidor que puede obtener estos datos y enviarle a algun programa
 * que los trate para mostrarlo
 *
 * @author sjpin
 */
public class Sistema {
    ...
    /**
     * Metodo que muestra el menu del operador
     */
    ...
    /**
     * Metodo que muestra el menu del cliente
     */
    ...
    /**
     * Interactuando con el archivo vehiculos.txt para poder obtener la
     * informacion y ponerla a disposicion al sistema
     */
    ...
    /**
     * Metodo que carga los horarios de revisiones y los guarda en la variable
     * estática horarios, la cual es de tipo Date.
     */
    ...
    /**
     * Interactúa con el archivo revisiones.txt para obtener la información y
     * ponerla a disposición del sistema para su posterior uso.
     */
    ...
    /**
     * Remueve del fichero el horario que un cliente ha sido seleccionado el
     * indice es el mismo de la lista
     *
    ...
    /**
     * Elimina de el archivo Revisiones, los datos dependiendo del indice de la
     * revision asociada con la lista generada por el sistema
     *
    ...
    /**
     * Elimina las multas que se han pagado con exito, con la referencia del
     * indice de la lista generadas por el sistema
     *
     * @param index indice a borrar
     */
    ...
    public static void main(String[] args) {
        ...
        while (sesion.equals("n")) {
            ...
            System.out.println("Ud ha cerrado Sesion con exito\nDesea Salir del programa No (n) Si(s):");
            sesion = sc.nextLine();
